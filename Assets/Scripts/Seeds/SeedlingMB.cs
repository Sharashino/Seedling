...
{
    public class SeedlingMB : MonoBehaviour
    {
        ...
        {
            growFlower = Instantiate(seedlingFlower, new Vector3(seedlingToGrowFrom.transform.position.x, seedlingToGrowFrom.transform.position.y + 0.18f, seedlingToGrowFrom.transform.position.z), seedlingToGrowFrom.transform.rotation);
